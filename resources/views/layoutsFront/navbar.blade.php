            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <a href="/property/property-list" class="nav-item nav-link {{ request()->is('property/property-list') ? 'active' : '' }}">Property List</a> 
                        <!-- <a href="/property/property-agent" class="nav-item nav-link {{ request()->is('property/property-agent') ? 'active' : '' }}">Property Agent</a> -->
                        <a href="/property/property-builder" class="nav-item nav-link {{ request()->is('property/property-builder') ? 'active' : '' }}">Property Builder</a>
                    ...
                    <a href="/contact" class="btn btn-primary px-3 d-none d-lg-flex"> Contact Us</a>
                </div>
            </nav>
        </div>