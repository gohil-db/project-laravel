...
@section('title', 'Property - Real Estate')

@section('content')
@include('layoutsFront.header-hero')
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <a class="cat-item d-block bg-light text-center rounded p-3" href="{{ route('property.byType', $type->name) }}">
                    ...
                    <div class="col-lg-6 text-start text-lg-end wow slideInRight" data-wow-delay="0.1s">
                        <ul class="nav nav-pills d-inline-flex justify-content-end mb-5">
                            <li class="nav-item me-2">
                                <a class="btn btn-outline-primary active tab-btn" data="all" data-bs-toggle="pill" href="#tab-0">All</a>
                            </li>
                            <li class="nav-item me-2">
                                <a class="btn btn-outline-primary tab-btn" data-filter="featured" data-bs-toggle="pill" href="#tab-1">Featured</a>
                            </li>
                            <li class="nav-item me-2">
                                <a class="btn btn-outline-primary tab-btn"  data-filter="sell" data-bs-toggle="pill" href="#tab-2">For Sell</a>
                            </li>
                            <li class="nav-item me-0">
                                <a class="btn btn-outline-primary tab-btn" data-filter="rent" data-bs-toggle="pill" href="#tab-3">For Rent</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="tab-content">
                    <div id="tab-0" class="tab-pane fade show p-0 active">
                        ...
                        <div class="col-12 text-center wow fadeInUp" data-wow-delay="0.1s">
                             <a class="btn btn-primary py-3 px-5" href="{{route('propertyList')}}">Browse More Property</a>
                        </div>
                    </div>
                    ...
                    <div class="testimonial-item bg-light rounded p-3">
                        <div class="bg-white border rounded p-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <img class="img-fluid flex-shrink-0 rounded" src="{{ asset($testimonial->image)}}" style="width: 45px; height: 45px;">
                                <div class="ps-3">
...
<!-- <script src="{{ asset('js/property-tabs.js') }}"></script> -->
  @vite(['resources/js/property-tabs.js'])
@endsection
